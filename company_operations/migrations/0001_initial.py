    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('demanded', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), blank=True, null=True, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expire_quantity', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('demanded', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), blank=True, null=True, size=None)),
                ('wh', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='DemandForecastingReports', to='company_operations.WareHouse')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('saled_quantity', models.IntegerField()),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='demand_forecastings', to='company_operations.Product')),
                ('to_report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='demand_forecastings', to='company_operations.DemandForecastingReport')),
                ('wh', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='demand_forecastings', to='company_operations.WareHouse')),
            ],
        ),
    ]
